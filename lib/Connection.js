...
Connection.prototype._resUntagged = function(info) {
  ...
  if (type === 'bye'){
    if(info.text.indexOf("Session") > -1 || info.text.indexOf("logging out") > -1){
